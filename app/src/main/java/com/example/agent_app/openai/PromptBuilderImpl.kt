...
class PromptBuilderImpl : PromptBuilder {
    override fun buildMessages(
        ...
        val systemContent = """
            ...
            5. 모르는 내용이면 "제공된 정보로는 답변할 수 없습니다"라고 답하세요.
            6. 추측하지 마세요.
            7. 답변은 한국어로 자연스럽고 친근한 톤으로 작성하되, 5문장 이내로 요약해 주세요.
            8. 일정이 있는 경우, 날짜와 시간을 명확하게 표시하세요.
            9. 사용자가 "그거", "그것", "저번에" 등 지시어를 사용하면 이전 대화를 참고하여 해석하세요.
        """.trimIndent()
